...
void handleFinishDraw(float x, float y)
{
	...
	if (shapeList[current].startX == shapeList[current].endX &&
		shapeList[current].startX == shapeList[current].endY)//means we didnt draw any shape
	{
		shapeCount--;
	}
...
void changeBaackGroundColor(int key ,int x,int y)
{
    switch(key)
    {
        case GLUT_KEY_F1: bkColor.r = 0;bkColor.g = 0;bkColor.b=0;bkColor.a = 0;break;//black
        case GLUT_KEY_F2: bkColor.r = 1;bkColor.g = 1,bkColor.b =1;bkColor.a = 1;break;//white
        case GLUT_KEY_F3: bkColor.r = 0.5;bkColor.g = 0.5,bkColor.b =0;bkColor.a = 0;break;//dark yellow
        case GLUT_KEY_F4: bkColor.r = 0.5;bkColor.g = 0,bkColor.b =0;bkColor.a = 0;break;// dark red
        case GLUT_KEY_HOME: clearPrimitives(); break;// clear the screen
        case GLUT_KEY_END: exit(0); break;// exit the application
        default:   break;
    }
    glutPostRedisplay();
}
/*
void execute(int key,int x,int y)
{
...
int main(int argc, char **argv)
{
	...
	glutSpecialFunc(changeBaackGroundColor);
